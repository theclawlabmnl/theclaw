...
export default async function BookPage(){
  ...
  const {data:services}=await db.from("services").select("id,name,description,price,duration_minutes,active,sort_order,service_variations(id,service_id,name,price_delta,duration_delta_minutes,active,sort_order)").eq("active",true).order("sort_order");
